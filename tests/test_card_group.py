...
# ################################
    ...
    # def test_trips_no_hand(self):
    #     trips = self.no_hand._trips()
    #     print trips
    #     assert bool(trips) == True
    #     print "---"
    #     print trips
    #     hand = trips['hand']
    ...
    # def test_quads_no_hand(self):
    #     quads = self.no_hand._quads()
    #     print quads
    #     assert bool(quads) == False

    # def test_quads_cg2(self):
    #     quads = self.cg2._quads()
    #     print quads
    #     assert bool(quads) == True
    #     print "---"
    #     print quads
    #     hand = quads['hand']
